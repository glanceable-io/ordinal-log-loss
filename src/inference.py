...
if __name__ == '__main__':
    ...
    output_path_metrics = f'{Path.home()}/ordinal_loss_research/src/outputs_training/output_metrics/metrics_test_set.csv'
    ...
    # Loading the models
    for dataset_file in ["snli","amazon_reviews","sst5","yelp"]:
        ...
        models_path = f"{Path.home()}/ordinal_loss_research/src/outputs_training/output_models/{dataset_file}/saved_models/{model_dir}"
        saved_models = np.sort(os.listdir(models_path))
        dictpath = {}
        offset = 28
        losses = ["CE","OLL15","OLL1","OLL2","WKL","SOFT2","SOFT3","SOFT4"]
